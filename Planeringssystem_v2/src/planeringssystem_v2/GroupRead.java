                ...
                if (ds.uppdrag.size() != 0) {
                    ...
                    while (uppdrag.size() != 0) {
                        ...
                        if (ds.uppdrag.size() == 1) {
                            gui.appendCapacity("uppdrag vi säger till gruppen vill ta är: " + ds.uppdrag.get(0));
                            msg = ds.valdPlats + "!" + ds.distanceCP + "!" + ds.uppdrag.get(0);
                        } else if (ds.uppdrag.size() > 1 && ds.uppdrag.size() != 0) {
                            gui.appendCapacity("uppdrag vi säger till gruppen vill ta är: " + ds.uppdrag.get(0) + " , " + ds.uppdrag.get(1) + "   " + ds.valdPlats + "!" + ds.distanceCP);
...
//                System.out.println("Grupp 5 Uppdrag" + uppdragGroup5);
                            ...
                            if (ds.uppdragsIDArray.length > 0) {
